                            ...
                            {selectedProduct?.id === product.id && product.product_shots && product.product_shots.length > 0 && (
                                <div className="mt-4 pt-4 border-t border-amber-200">
                                    <label className="flex items-center gap-3 cursor-pointer group">
                                        <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${useProductShots ? 'bg-amber-600 border-amber-600' : 'bg-card border-border group-hover:border-amber-500'}`}>
                                        ...
                                        />
                                        <div>
                                            <span className="text-sm font-medium text-foreground">Use Product Shots</span>
                                            <p className="text-xs text-muted-foreground">Include uploaded product images in the generation process</p>
                                        </div>
                                    </label>
