        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <button
                    ...
                    className="group relative flex flex-col items-start p-8 bg-card rounded-2xl border-2 border-border hover:border-amber-500/30 hover:shadow-xl transition-all duration-300 text-left"
                >
                    <div className="w-16 h-16 bg-amber-500/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="mt-auto flex items-center gap-2 text-amber-500 font-semibold group-hover:gap-3 transition-all">
                ...
                <button
                    ...
                    className="group relative flex flex-col items-start p-8 bg-card rounded-2xl border-2 border-border hover:border-blue-500/30 hover:shadow-xl transition-all duration-300 text-left"
                >
                    ...
                    <div className="mt-auto flex items-center gap-2 text-blue-500 font-semibold group-hover:gap-3 transition-all">
                        Start Creating <ArrowRight size={20} />
                    </div>
                </button>
                ...
                <button
                    ...
                    className="group relative flex flex-col items-start p-8 bg-card rounded-2xl border-2 border-border hover:border-purple-500/30 hover:shadow-xl transition-all duration-300 text-left md:col-span-2"
                >
                    ...
                    <h3 className="text-2xl font-bold text-foreground mb-3">Modular Script Matrix <span className="text-xs ml-2 bg-purple-500/10 text-purple-400 px-2 py-1 rounded-full uppercase tracking-wider font-semibold">New Workflow</span></h3>
                    ...
                    <div className="mt-auto flex items-center gap-2 text-purple-500 font-semibold group-hover:gap-3 transition-all">
