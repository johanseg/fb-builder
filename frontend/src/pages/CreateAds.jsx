        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <button
                    ...
                    className="group relative flex flex-col items-start p-8 bg-white rounded-2xl border-2 border-gray-100 hover:border-purple-200 hover:shadow-xl transition-all duration-300 text-left md:col-span-2"
                >
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Modular Script Matrix <span className="text-xs ml-2 bg-purple-100 text-purple-600 px-2 py-1 rounded-full uppercase tracking-wider font-semibold">New Workflow</span></h3>
