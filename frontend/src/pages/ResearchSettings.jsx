    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-6">
                ...
                {blacklist.length === 0 ? (
                    <p className="text-muted-foreground text-center py-8">No blacklisted pages</p>
                ) : (
                    <div className="space-y-2">
                        {blacklist.map((item) => (
                            <div key={item.id} className="flex justify-between items-center p-3 bg-secondary rounded border border-border">
                                <div>
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border p-6">
                ...
                {keywordBlacklist.length === 0 ? (
                    <p className="text-muted-foreground text-center py-8">No blacklisted keywords</p>
                ) : (
